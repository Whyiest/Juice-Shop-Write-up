...
<img src="../assets/difficulty3/payback_time_1.png" alt="403" width="700px">
...
3. **Identify Account with Necessary Permissions**:
   ...
   <img src="../assets/difficulty3/payback_time_2.png" alt="email of accountant" width="700px">
   ...
   <img src="../assets/difficulty3/payback_time_3.png" alt="SQL Injection" width="700px">
...
1. **Access Accounting Page as the Accountant**:
   ...
   <img src="../assets/difficulty3/payback_time_4.png" alt="accoutant panel" width="700px">
...
2. **Attempt to Modify Product Prices**:
   ...
   <img src="../assets/difficulty3/payback_time_5.png" alt="update price request" width="700px">
...
3. **Manipulate Product Pricing**:
   ...
   - The server accepted this modified request, updating the product price to the negative value.
     ...
     <img src="../assets/difficulty3/payback_time_6.png" alt="updated product" width="700px">
...
4. **Exploit Negative Pricing**:
   ...
   <img src="../assets/difficulty3/payback_time_7.png" alt="purchase" width="700px">
